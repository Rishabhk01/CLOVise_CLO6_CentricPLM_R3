...
* @date 14-AUG-2020
*/
#include "ui_UpdateImageIntent.h"
...
namespace CLOVise
{
	class UpdateImageIntent : public MVDialog, public Ui::UpdateImageIntent
	{
		Q_OBJECT

	public:
		static UpdateImageIntent* GetInstance();
		static void	Destroy();
		...
		bool IsValidImageIntent(QString _selectedSnapshot, QStringList _selectedImageLabels, QString _selectedColorway, int _view);
		void fillSelectedList(QStringList _colorwayNames);
		void StyleOrColorwayDropdownClicked(const QString& _item);
	...
	private:
		...
		static UpdateImageIntent* _instance;
