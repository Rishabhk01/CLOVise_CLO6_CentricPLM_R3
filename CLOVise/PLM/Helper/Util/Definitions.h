...
#define CLO_COLORWAY_COLUMN 3
#define COLOR_CHIP_COLUMN 4
#define COLOR_NAME_COLUMN 5
#define COLOR_CODE_COLUMN 6
#define PANTONE_CODE_COLUMN 7
#define UNI_2_DIGIT_CODE_COLUMN 8
#define DESCRIPTION_COLUMN 9
